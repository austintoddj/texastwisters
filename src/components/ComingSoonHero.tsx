...
import { ComingSoonHeroData } from '@/types'
import Link from 'next/link'

interface ComingSoonHeroProps {
  data: ComingSoonHeroData
}

export const ComingSoonHero = ({ data }: ComingSoonHeroProps) => {
      ...
      <div className="mx-auto max-w-(--breakpoint-xl)">
        ...
        <div className="relative flex flex-col items-center">
          ...
          <div className="flex flex-col items-center gap-4 mt-8 sm:flex-row">
            ...
            {hasSecondary && !hasPreText && data.secondaryCta.href && (
