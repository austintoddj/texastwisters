...
const blocks = [
    {
        ...
        headline: "A place where athletes to feel connected, supported, and inspired",
        ...
        action: { label: 'About us', href: '/staff', icon: true },
        portraitImage: { src: portraitImage1, alt: 'Girl doing a handstand on a balance beam' },
        squareImage: { src: squareImage1, alt: 'Group of boys smiling with their arms around each other' },
    },
    {
        ...
        action: { label: 'Our core values', href: '/staff#values', icon: true },
        portraitImage: { src: portraitImage2, alt: 'Coach supporting a small girl in a preschool class' },
        squareImage: { src: squareImage2, alt: 'Little girl smiling in a preschool gymnastics class' },
    },
]
