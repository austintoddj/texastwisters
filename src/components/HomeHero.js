            ...
            >
                ...
                <div className="flex flex-col items-center justify-center lg:items-start lg:col-span-6">
                    ...
                    <p className="max-w-2xl mt-3 text-xl leading-loose text-center text-purple-800 lg:text-left">
                        Located in the heart of Georgetown, our program is
                        designed to challenge and inspire gymnasts of all
                        levels. From beginner to advanced, we'll provide you
                        with a safe, supportive, and fun environment to learn
                        and grow.
                    </p>
                    {/* Hero buttons */}
